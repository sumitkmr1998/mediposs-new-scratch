      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    const Expanded(
                      child: Text(
                        'CRITICAL: This medicine has EXPIRED stock batches! Please remove them from inventory immediately.',
                        style: TextStyle(
                          color: AppTheme.danger,
            ...
            else if (medicine.hasNearExpiryBatch)
              Container(
                width: double.infinity,
                padding: const EdgeInsets.all(16),
                margin: const EdgeInsets.only(bottom: 12),
                ...
                child: Row(
                  children: [
                    ...
                    const Expanded(
                      child: Text(
                        'WARNING: Some batches are nearing expiry (within 90 days).',
                        style: TextStyle(
                          color: Colors.orange,
            ...
            // Batches section
            Text('Stock Batches', style: Theme.of(context).textTheme.titleLarge),
            const SizedBox(height: 12),
            Card(
              child: medicine.batches.isEmpty
                  ? const Padding(
                      padding: EdgeInsets.all(24),
                      child: Center(
                        child: Text(
                          'No batch information available for this medicine.',
                        ...
                        rows: medicine.batches.map((b) {
                          ...
                          return DataRow(
                            cells: [
                              ...
                              DataCell(Text('${b.storeStock}')),
                              DataCell(Text('${b.mainStock}')),
                              DataCell(
                                Text(
                                  '${b.storeStock + b.mainStock}',
